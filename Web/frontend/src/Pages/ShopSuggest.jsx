...
export const ShopSuggest = () => {
  ...
  const filteredData = useMemo(() => {
    ...
    return products.filter((item) => category === "Full products" ? true : item.category.toLocaleLowerCase() === category.toLocaleLowerCase());
  }, [products, category]);
  ...
  return (
    <div className="w-full">
      <div className="flex justify-center h-[560px] mt-7 mx-24 ">
        ...
        />
        <div
          className={`bg-white w-full ml-10 transition-all duration-700 rounded-2xl shadow-2xl py-4 px-5 overflow-hidden relative  ${
